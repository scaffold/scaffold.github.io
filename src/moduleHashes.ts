...
export const wrapper_wasm_hash = Hash.fromHex(
  '53b7462fd8fc0dd460ab2c2bad77f4f9ccc8b20db1d015ea0d6a3769f882eef5',
);
export const python_wasm_hash = Hash.fromHex(
...
export const true_generator_0_js_hash = Hash.fromHex(
